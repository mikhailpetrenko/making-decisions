...
/*
  ...
  create code that will log a suggestion on what type of clothes one should wear for the day, based on the above temperature and rain.
...
if (temperature > 80) {
  ...
  } else {console.log("Wear as less clothes as you wouldn't be judged for")}
  ...
  console.log("Wear just a jacket")
  }
}
